$(document).ready(function() {
    ...
    */
	...
	setTimeout(function() {
		var tab1 = $('.ch-tabs.tab1').html();
		var tab2 = $('.ch-tabs.tab2').html();
		var tab3 = $('.ch-tabs.tab3').html();

		$('.ch-tab-mob.tab1').html(tab1);
		$('.ch-tab-mob.tab2').html(tab2);
		$('.ch-tab-mob.tab3').html(tab3);
